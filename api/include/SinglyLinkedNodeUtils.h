...
#define SINGLY_LINKED_NODE_OKAY(x) ((x) == NODE_STATUS_NO_ERROR)

#define SINGLY_LINKED_NODE_ERROR(x) ((x) != NODE_STATUS_NO_ERROR)
...
switch (create_singly_linked_##type##_node(&name)) {											\
	case NODE_STATUS_NULL: malloc_code_block break;												\
																								\
	case NODE_STATUS_MALLOC: null_code_block break;												\
																								\
	default:																					\
	break;																						\
}																								\
